...
public class DefectPixelInterpolation {
	...
	public static void main(String[] args) {
		...
		String filename = "/proj/i5dmip/bi24kuwe/Reconstruction/CONRAD/src/edu/stanford/rsl/tutorial/dmip/testimg.bmp";
		String filenameMask = "/proj/i5dmip/bi24kuwe/Reconstruction/CONRAD/src/edu/stanford/rsl/tutorial/dmip/mask.bmp";
		...
		boolean zeroPadding = true;//zero padding for increasing image resolution & stop image info loss
		int maxIter = 4000;
