...
public class SVDandFT {
		...
		for(int k = 0; k < rank; k++)
		{
			...
			for(int i = 0; i < image.getHeight(); i++)
			{
				for(int j = 0; j < image.getWidth(); j++)
				{
					...
					{
						imageRank.setAtIndex(j, i, imageRanks.getAtIndex(j, i, k-1)+
								(float) Iapprox.getElement(i, j));
					}
	...
	public static void fourierExercise(Grid2D image)
	{
		...
		Grid2D imageTransf=imageC.getMagnSubGrid(0, 0, imageC.getWidth(), imageC.getHeight());
		imageTransf.show();
	}
	...
	public static void main(String[] args) {
		...
		String filename = "/home/cip/medtech2015/bi24kuwe/DMIP/Reconstruction/CONRAD/src/edu/stanford/rsl/tutorial/dmip/yu_fill.jpg";
		...
		String filenameShepp = "/home/cip/medtech2015/bi24kuwe/DMIP/Shepp-Logan Phantom.tif";
